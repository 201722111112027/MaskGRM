...
def main():
    ...
    parser.add_argument('--num_gpus', type=int, default=2, help='num of GPUs you want to use')
    parser.add_argument('--num_cpus', type=int, default=2, help='num of CPUs you want to use')
