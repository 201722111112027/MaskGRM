...
def parse_args():
    ...
    # for train
    parser.add_argument('--script', type=str, default='mixformer_online',
...
def evaluate(model, template, search, skip=200, display_info='GRM'):
...
if __name__ == "__main__":
    ...
    model_module = importlib.import_module('lib.models.grm')
    if args.script == "grm":
...
# python tracking/profile_model.py --script grm --config vitb_256_ep300 --online_skip 200 --display_name 'GRM'